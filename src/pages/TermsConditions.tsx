  ...
  return (
    <Container size='md' my='lg' py='xl'>
      <Stack gap='lg'>
        ...
        <Text c='dimmed'>Last updated: March 28, 2026</Text>
        ...
        <section>
          <Title order={2}>1. Use of the Website</Title>
          <Text>
            By using this website, you agree to use it only for lawful purposes.
            You must not use the website in any way that may damage the
            platform, disrupt services, or interfere with other users.
          </Text>
        </section>

        <section>
          <Title order={2}>2. User Responsibilities</Title>
          <Text>
            Users are responsible for providing accurate information when
            placing orders or creating accounts. Any misuse of the platform,
            fraudulent activity, or violation of these terms may result in
            account suspension or termination.
          </Text>
        </section>

        <section>
          <Title order={2}>3. Products and Orders</Title>
          <Text>
            We strive to ensure that all product descriptions, images, and
            prices are accurate. However, we reserve the right to correct
            errors, update information, or cancel orders if necessary.
          </Text>
        </section>

        <section>
          <Title order={2}>4. Limitation of Liability</Title>
          <Text>
        ...
        <section>
          <Title order={2}>6. Cookies Policy</Title>
          <Text>
            ...
            files stored on your device that help us recognize returning users
            and understand how visitors interact with the website.
          </Text>
          <Text>
        ...
        <section>
          <Title order={2}>7. Changes to These Terms</Title>
          <Text>
            We reserve the right to update or modify these Terms and Conditions
            at any time. Changes will be posted on this page and will take
